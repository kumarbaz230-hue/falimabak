...
_METINLER = {
    ...
    'settings_notif_hint': {'tr': 'Her 2 saatte bir fal hatırlatması gönderilir.', 'en': 'Fortune reminder every 2 hours.', 'de': 'Erinnerung alle 2 Stunden.', 'fr': 'Rappel toutes les 2 heures.', 'es': 'Recordatorio cada 2 horas.', 'ar': 'تذكير كل ساعتين.', 'ru': 'Напоминание каждые 2 часа.', 'pt': 'Lembrete a cada 2 horas.', 'it': 'Promemoria ogni 2 ore.', 'hi': 'हर 2 घंटे में याद दिलाएँ।', 'id': 'Pengingat setiap 2 jam.', 'zh': '每 2 小时提醒一次。'},
