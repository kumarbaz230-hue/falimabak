...
_METINLER = {
    ...
    'coin_fal_cost': {'tr': 'Her fal {cost} coin harcar. Burç eşleşmesi ücretsizdir.', 'en': 'Each reading costs {cost} coin. Zodiac match is free.', 'de': 'Jede Deutung kostet {cost} Münze.', 'fr': 'Chaque lecture coûte {cost} pièce.', 'es': 'Cada lectura cuesta {cost} moneda.', 'ar': 'كل قراءة {cost} عملة.', 'ru': 'Каждое гадание — {cost} монета.', 'pt': 'Cada leitura custa {cost} moeda.', 'it': 'Ogni lettura costa {cost} moneta.', 'hi': 'प्रति फ़ाल {cost} सिक्का।', 'id': 'Setiap bacaan {cost} koin.', 'zh': '每次占卜消耗 {cost} 金币。'},
