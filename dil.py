...
_METINLER = {
    ...
    'menu_ruya_desc': {'tr': 'Rüyanızı yazın, FalımaBak tabir etsin', 'en': 'Describe your dream for an AI reading', 'de': 'Traum beschreiben — KI-Deutung', 'fr': 'Décrivez votre rêve', 'es': 'Describe tu sueño', 'ar': 'صف حلمك', 'ru': 'Опишите свой сон', 'pt': 'Descreva seu sonho', 'it': 'Descrivi il tuo sogno', 'hi': 'अपना सपना लिखें', 'id': 'Ceritakan mimpimu', 'zh': '描述您的梦境'},
    ...
    'ruya_aciklama': {'tr': 'Gördüğünüz rüyayı olabildiğince ayrıntılı yazın. FalımaBak sembolleri yapay zekâ ile yorumlar (eğlence amaçlıdır).', 'en': 'Describe your dream in detail. FalımaBak interprets symbols via AI (for entertainment).', 'de': 'Beschreiben Sie Ihren Traum. KI-Deutung zu Unterhaltungszwecken.', 'fr': 'Décrivez votre rêve en détail. Interprétation par IA (divertissement).', 'es': 'Describe tu sueño. Interpretación con IA (entretenimiento).', 'ar': 'صف حلمك بالتفصيل. تفسير بالذكاء الاصطناعي للترفيه.', 'ru': 'Опишите сон подробно. ИИ-толкование для развлечения.', 'pt': 'Descreva seu sonho. Interpretação por IA (entretenimento).', 'it': 'Descrivi il sogno. Interpretazione IA (intrattenimento).', 'hi': 'सपना विस्तार से लिखें।', 'id': 'Ceritakan mimpi Anda. Tafsir AI (hiburan).', 'zh': '详细描述梦境。AI 解读（娱乐用途）。'},
    ...
    'ruya_yorumlaniyor': {'tr': 'Semboller FalımaBak tarafından yorumlanıyor…', 'en': 'FalımaBak is interpreting the symbols…', 'de': 'Symbole werden gedeutet…', 'fr': 'Interprétation en cours…', 'es': 'Interpretando símbolos…', 'ar': 'جاري التفسير…', 'ru': 'Толкование символов…', 'pt': 'Interpretando símbolos…', 'it': 'Interpretazione in corso…', 'hi': 'प्रतीक व्याख्या हो रही है…', 'id': 'Menafsirkan simbol…', 'zh': '正在解读符号…'},
