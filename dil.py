...
_METINLER = {
    ...
    'settings_rate_hint': {'tr': 'İlk değerlendirmenizde 3 coin kazanırsınız.', 'en': 'Earn 3 coins on your first rating.', 'de': '3 Münzen bei der ersten Bewertung.', 'fr': '3 pièces à la première note.', 'es': '3 monedas en la primera valoración.', 'ar': '3 عملات عند أول تقييم.', 'ru': '3 монеты за первую оценку.', 'pt': '3 moedas na primeira avaliação.', 'it': '3 monete alla prima valutazione.', 'hi': 'पहली रेटिंग पर 3 सिक्के।', 'id': '3 koin untuk penilaian pertama.', 'zh': '首次评价得 3 金币。'},
    'settings_rate_reward': {'tr': 'Teşekkürler! +{coin} coin hesabınıza eklendi.', 'en': 'Thanks! +{coin} coins added.', 'de': 'Danke! +{coin} Münzen.', 'fr': 'Merci ! +{coin} pièces.', 'es': '¡Gracias! +{coin} monedas.', 'ar': 'شكراً! +{coin} عملة.', 'ru': 'Спасибо! +{coin} монет.', 'pt': 'Obrigado! +{coin} moedas.', 'it': 'Grazie! +{coin} monete.', 'hi': 'धन्यवाद! +{coin} सिक्के।', 'id': 'Terima kasih! +{coin} koin.', 'zh': '谢谢！+{coin} 金币。'},
    'settings_rate_done': {'tr': 'Play Store açıldı. Ödül daha önce alındı.', 'en': 'Play Store opened. Reward already claimed.', 'de': 'Play Store geöffnet. Belohnung bereits erhalten.', 'fr': 'Play Store ouvert. Récompense déjà reçue.', 'es': 'Play Store abierto. Recompensa ya reclamada.', 'ar': 'تم فتح المتجر. المكافأة مُستَلَمة.', 'ru': 'Play Store открыт. Награда уже получена.', 'pt': 'Play Store aberto. Recompensa já resgatada.', 'it': 'Play Store aperto. Ricompensa già ricevuta.', 'hi': 'Play Store खुला। पुरस्कार पहले मिल चुका।', 'id': 'Play Store dibuka. Hadiah sudah diambil.', 'zh': '已打开 Play Store。奖励已领取。'},
    'settings_rate_fail': {'tr': 'Play Store açılamadı.', 'en': 'Could not open Play Store.', 'de': 'Play Store konnte nicht geöffnet werden.', 'fr': 'Impossible d\'ouvrir le Play Store.', 'es': 'No se pudo abrir Play Store.', 'ar': 'تعذّر فتح المتجر.', 'ru': 'Не удалось открыть Play Store.', 'pt': 'Não foi possível abrir a Play Store.', 'it': 'Impossibile aprire Play Store.', 'hi': 'Play Store नहीं खुला।', 'id': 'Play Store tidak bisa dibuka.', 'zh': '无法打开 Play Store。'},
    'settings_notif': {'tr': 'Hatırlatmalar', 'en': 'Reminders', 'de': 'Erinnerungen', 'fr': 'Rappels', 'es': 'Recordatorios', 'ar': 'تذكيرات', 'ru': 'Напоминания', 'pt': 'Lembretes', 'it': 'Promemoria', 'hi': 'अनुस्मारक', 'id': 'Pengingat', 'zh': '提醒'},
    'settings_notif_hint': {'tr': 'Gün içinde fal hatırlatmaları gönderelim mi?', 'en': 'Send fortune reminders during the day?', 'de': 'Wahrsage-Erinnerungen senden?', 'fr': 'Envoyer des rappels de voyance ?', 'es': '¿Enviar recordatorios de fortuna?', 'ar': 'إرسال تذكيرات الطالع؟', 'ru': 'Отправлять напоминания о гадании?', 'pt': 'Enviar lembretes de sorte?', 'it': 'Inviare promemoria di fortuna?', 'hi': 'भाग्य अनुस्मारक भेजें?', 'id': 'Kirim pengingat ramalan?', 'zh': '发送占卜提醒？'},
    'settings_notif_on': {'tr': 'Periyodik hatırlatma', 'en': 'Periodic reminder', 'de': 'Periodische Erinnerung', 'fr': 'Rappel périodique', 'es': 'Recordatorio periódico', 'ar': 'تذكير دوري', 'ru': 'Периодическое напоминание', 'pt': 'Lembrete periódico', 'it': 'Promemoria periodico', 'hi': 'आवधिक अनुस्मारक', 'id': 'Pengingat berkala', 'zh': '定期提醒'},
    'settings_notif_on_msg': {'tr': 'Hatırlatmalar açıldı.', 'en': 'Reminders enabled.', 'de': 'Erinnerungen aktiviert.', 'fr': 'Rappels activés.', 'es': 'Recordatorios activados.', 'ar': 'تم تفعيل التذكيرات.', 'ru': 'Напоминания включены.', 'pt': 'Lembretes ativados.', 'it': 'Promemoria attivati.', 'hi': 'अनुस्मारक चालू।', 'id': 'Pengingat aktif.', 'zh': '提醒已开启。'},
    'settings_notif_off_msg': {'tr': 'Hatırlatmalar kapatıldı.', 'en': 'Reminders disabled.', 'de': 'Erinnerungen deaktiviert.', 'fr': 'Rappels désactivés.', 'es': 'Recordatorios desactivados.', 'ar': 'تم إيقاف التذكيرات.', 'ru': 'Напоминания выключены.', 'pt': 'Lembretes desativados.', 'it': 'Promemoria disattivati.', 'hi': 'अनुस्मारक बंद।', 'id': 'Pengingat nonaktif.', 'zh': '提醒已关闭。'},
    'settings_notif_battery': {'tr': 'Bildirim gelmiyor mu? Pil ayarı', 'en': 'No notifications? Battery setting'},
    'notif_battery_title': {'tr': 'Bildirimler için son adım', 'en': 'One step for notifications'},
    ...
    'settings_faq': {
        'tr': (
            '• Her fal 1 coin harcar. Reklam izleyerek coin kazanabilirsiniz.\n'
            '• Kahve falı için fincan ve telveyi birlikte net çekin.\n'
            '• Geçmiş fallarınız Ayarlar → Geçmişi Temizle ile silinebilir.\n'
            '• Fal yorumları eğlence amaçlıdır; tıbbi veya hukuki tavsiye değildir.'
        ),
        'en': (
            '• Each reading costs 1 coin. Watch ads to earn coins.\n'
            '• For coffee readings, photograph cup and grounds together.\n'
            '• Clear history in Settings.\n'
            '• Readings are for entertainment only.'
        ),
    },
    'notif_title': {'tr': 'FalımaBak', 'en': 'FalımaBak', 'de': 'FalımaBak', 'fr': 'FalımaBak', 'es': 'FalımaBak', 'ar': 'FalımaBak', 'ru': 'FalımaBak', 'pt': 'FalımaBak', 'it': 'FalımaBak', 'hi': 'FalımaBak', 'id': 'FalımaBak', 'zh': 'FalımaBak'},
    'notif_body': {'tr': 'Bugün falına baktın mı? FalımaBak seni bekliyor.', 'en': 'Did you check your fortune today? FalımaBak is waiting.', 'de': 'Heute schon gelegt? FalımaBak wartet.', 'fr': 'Votre oracle du jour ? FalımaBak vous attend.', 'es': '¿Ya miraste tu suerte hoy? FalımaBak te espera.', 'ar': 'هل فحصت حظك اليوم؟ FalımaBak ينتظرك.', 'ru': 'Гадали сегодня? FalımaBak ждёт.', 'pt': 'Já consultou hoje? FalımaBak espera.', 'it': 'Hai consultato oggi? FalımaBak ti aspetta.', 'hi': 'आज फ़ाल देखा? FalımaBak इंतज़ार कर रहा है।', 'id': 'Sudah meramal hari ini? FalımaBak menunggu.', 'zh': '今天占卜了吗？FalımaBak 在等你。'},
    ...
    'foto_kahve_yok': {'tr': '{baslik} fotoğrafı kahve falı için uygun görünmüyor.', 'en': '{baslik} does not look suitable for coffee reading.', 'de': '{baslik} ungeeignet.', 'fr': '{baslik} inadapté.', 'es': '{baslik} no apto.', 'ar': '{baslik} غير مناسب.', 'ru': '{baslik} не подходит.', 'pt': '{baslik} inadequado.', 'it': '{baslik} non adatto.', 'hi': '{baslik} उपयुक्त नहीं।', 'id': '{baslik} tidak cocok.', 'zh': '{baslik} 不适合。'},
    'foto_fincan_yok': {'tr': '{baslik} fotoğrafında fincan telvesi net görünmüyor. Fincanı içten çekin.', 'en': 'Coffee grounds not clear in {baslik}. Photograph inside the cup.', 'de': 'Telves in {baslik} nicht klar.', 'fr': 'Marc peu visible dans {baslik}.', 'es': 'Posos no claros en {baslik}.', 'ar': 'التفل غير واضح في {baslik}.', 'ru': 'Кофе не видно в {baslik}.', 'pt': 'Borra não visível em {baslik}.', 'it': 'Fondi non chiari in {baslik}.', 'hi': '{baslik} में तलवा साफ नहीं।', 'id': 'Ampas tidak jelas di {baslik}.', 'zh': '{baslik} 中咖啡渣不清晰。'},
    'foto_tabak_yok': {'tr': '{baslik} fotoğrafında tabak ve telve izleri net görünmüyor. Tabağı üstten çekin.', 'en': 'Saucer and grounds not clear in {baslik}. Photograph from above.', 'de': 'Untertasse in {baslik} nicht klar.', 'fr': 'Soucoupe peu visible dans {baslik}.', 'es': 'Plato no claro en {baslik}.', 'ar': 'الصحن غير واضح في {baslik}.', 'ru': 'Блюдце не видно в {baslik}.', 'pt': 'Pires não visível em {baslik}.', 'it': 'Piattino non chiaro in {baslik}.', 'hi': '{baslik} में थाली साफ नहीं।', 'id': 'Piring tidak jelas di {baslik}.', 'zh': '{baslik} 中碟子不清晰。'},
