...
_METINLER = {
    ...
    'limit_msg': {'tr': 'Bugün {tip} için {limit} ücretsiz hakkınız doldu. 1 ödüllü reklam izleyerek +1 hak kazanın (günde 1 kez).', 'en': 'Free {tip} limit ({limit}) reached. Watch 1 rewarded ad for +1 (once per day).', 'de': '{tip}-Limit ({limit}). 1 belohnte Werbung für +1 (1×/Tag).', 'fr': 'Limite {tip} ({limit}). 1 pub récompensée pour +1 (1×/jour).', 'es': 'Límite {tip} ({limit}). 1 anuncio recompensado para +1 (1×/día).', 'ar': 'حد {tip} ({limit}). إعلان واحد بمكافأة لـ +1 (مرة/يوم).', 'ru': 'Лимит {tip} ({limit}). 1 реклама с наградой для +1 (1×/день).', 'pt': 'Limite {tip} ({limit}). 1 anúncio recompensado para +1 (1×/dia).', 'it': 'Limite {tip} ({limit}). 1 annuncio premiato per +1 (1×/giorno).', 'hi': '{tip} सीमा ({limit})। +1 के लिए 1 इनाम विज्ञापन (दिन में 1)।', 'id': 'Batas {tip} ({limit}). 1 iklan berhadiah untuk +1 (1×/hari).', 'zh': '{tip}免费{limit}次已满。1次奖励广告+1（每日1次）。'},
    'limit_reklam_doldu': {'tr': 'Bugün {tip} için ödüllü reklam hakkınızı kullandınız ({limit} ücretsiz + 1 reklam). Yarın yenilenir.', 'en': 'You used today\'s rewarded ad for {tip} ({limit} free + 1 ad). Resets tomorrow.', 'de': 'Belohnte Werbung für {tip} heute verbraucht. Morgen neu.', 'fr': 'Pub récompensée {tip} utilisée aujourd\'hui. Demain.', 'es': 'Anuncio recompensado de {tip} usado hoy. Mañana.', 'ar': 'استخدمت إعلان {tip} اليوم. غداً.', 'ru': 'Реклама {tip} сегодня использована. Завтра.', 'pt': 'Anúncio recompensado de {tip} usado hoje. Amanhã.', 'it': 'Annuncio premiato {tip} usato oggi. Domani.', 'hi': 'आज {tip} विज्ञापन उपयोग हो गया। कल।', 'id': 'Iklan {tip} hari ini sudah dipakai. Besok.', 'zh': '今日{tip}奖励广告已用。明日重置。'},
