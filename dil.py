...
_METINLER = {
    ...
    'limit_msg': {'tr': 'Bugün {tip} için günlük {limit} hakkınız doldu (diğer fallar ayrı sayılır). Ödüllü reklamı sonuna kadar izleyerek +1 {tip} hakkı kazanın. Yarın yenilenir.', 'en': 'Daily {tip} limit reached ({limit} per type). Watch a rewarded ad to the end for +1 {tip}. Resets tomorrow.', 'de': '{tip}-Limit ({limit}). Belohnte Werbung bis Ende für +1.', 'fr': 'Limite {tip} ({limit}). Pub récompensée complète pour +1.', 'es': 'Límite de {tip} ({limit}). Anuncio recompensado completo para +1.', 'ar': 'حد {tip}. إعلان بمكافأة حتى النهاية لـ +1.', 'ru': 'Лимит {tip}. Досмотрите рекламу с наградой для +1.', 'pt': 'Limite de {tip}. Anúncio recompensado completo para +1.', 'it': 'Limite {tip}. Annuncio premiato completo per +1.', 'hi': '{tip} सीमा। पूरा इनाम विज्ञापन +1 के लिए।', 'id': 'Batas {tip}. Iklan berhadiah penuh untuk +1.', 'zh': '{tip}已达{limit}次。完整观看奖励广告+1。'},
