...
android.permissions = INTERNET,ACCESS_NETWORK_STATE,AD_ID,CAMERA,POST_NOTIFICATIONS,RECEIVE_BOOT_COMPLETED,WAKE_LOCK
...
android.gradle_dependencies = androidx.appcompat:appcompat:1.6.1,androidx.activity:activity:1.8.2,androidx.core:core:1.12.0,com.google.android.gms:play-services-ads:25.4.0,com.google.android.play:review:2.0.2,com.google.android.play:app-update:2.1.0
