...
android.permissions = INTERNET,ACCESS_NETWORK_STATE,AD_ID,CAMERA,POST_NOTIFICATIONS,SCHEDULE_EXACT_ALARM,USE_EXACT_ALARM,RECEIVE_BOOT_COMPLETED,WAKE_LOCK
